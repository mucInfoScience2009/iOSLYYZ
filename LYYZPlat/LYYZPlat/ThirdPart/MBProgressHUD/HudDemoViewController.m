...
@property (retain, nonatomic) IBOutletCollection(UIButton) NSArray *mybuttons;
...
- (void)viewDidLoad {
    ...
    for (UIButton *btn in self.mybuttons) {
        btn.layer.cornerRadius = 5;
        btn.layer.backgroundColor = [UIColor whiteColor].CGColor;
    }
    self.view.backgroundColor = RGBCOLOR_HEX(0x123456);
}
